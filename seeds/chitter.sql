...
INSERT INTO users (username, name, email, password) VALUES ('user1', 'name name1', 'email1@email.com', 'password1');
INSERT INTO users (username, name, email, password) VALUES ('user2', 'name name2', 'email2@email.com', 'password2');
